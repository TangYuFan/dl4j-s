...
import static cn.xsshome.recogntion.face.FaceNetSmallV2Model.paddingIndex;
import static cn.xsshome.recogntion.face.FaceNetSmallV2Model.reluIndex;

public class FaceNetSmallV2Helper {
	private final static Logger LOGGER = LoggerFactory.getLogger(FaceNetSmallV2Helper.class);
