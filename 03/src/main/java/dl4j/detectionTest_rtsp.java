 ...
 * @data : 2019/6/12
 */
public class detectionTest_rtsp {
    ...
    public static void train() throws Exception {
        ...
        //rtsp视频源
        FFmpegFrameGrabber grabber = new FFmpegFrameGrabber("rtsp://192.168.1.116:556/1");
        grabber.setOption("rtsp_transport","tcp");
        grabber.setFrameRate(30);
        grabber.setVideoBitrate(3000000);
        OpenCVFrameConverter.ToIplImage converter = new OpenCVFrameConverter.ToIplImage();
        NativeImageLoader imageLoader = new NativeImageLoader(height, width, 3);
        ...
        try {
            ...
            while (frame!= null) {
                ...
                scr = imread("D:\\my_idea_workspace\\dl4j\\dl4j\\03\\JPEG\\1.jpg", IMREAD_COLOR);

                //mat转INDArray
                INDArray in = imageLoader.asMatrix(scr);
                //INDArray归一化
                ...
                System.out.println("目标个数:"+objs.size());
                if(objs.size()!=0){
